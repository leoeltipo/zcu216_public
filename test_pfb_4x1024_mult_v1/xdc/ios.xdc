...
#set_property PACKAGE_PIN M14       [get_ports "PMOD1_2_LS"];
#set_property IOSTANDARD  LVCMOS18  [get_ports "PMOD1_2_LS"];
#set_property PACKAGE_PIN N14       [get_ports "PMOD1_3_LS"];
#set_property IOSTANDARD  LVCMOS18  [get_ports "PMOD1_3_LS"];
#set_property PACKAGE_PIN M15       [get_ports "PMOD1_4_LS"];
#set_property IOSTANDARD  LVCMOS18  [get_ports "PMOD1_4_LS"];
#set_property PACKAGE_PIN N15       [get_ports "PMOD1_5_LS"];
#set_property IOSTANDARD  LVCMOS18  [get_ports "PMOD1_5_LS"];
#set_property PACKAGE_PIN M16       [get_ports "PMOD1_6_LS"];
#set_property IOSTANDARD  LVCMOS18  [get_ports "PMOD1_6_LS"];
#set_property PACKAGE_PIN N16       [get_ports "PMOD1_7_LS"];
#set_property IOSTANDARD  LVCMOS18  [get_ports "PMOD1_7_LS"];
