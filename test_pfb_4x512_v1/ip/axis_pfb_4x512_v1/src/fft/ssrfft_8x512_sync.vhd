...
architecture rtl of ssrfft_8x512_sync is
...
-- FFT scale.
signal o_scale			: std_logic_vector (8 downto 0);
...
-- Registers.
signal scale_reg_i		: std_logic_vector (8 downto 0);
signal qout_reg_i		: unsigned (3 downto 0);

begin

-- Registers.
scale_reg_i <= SCALE_REG (8 downto 0);
