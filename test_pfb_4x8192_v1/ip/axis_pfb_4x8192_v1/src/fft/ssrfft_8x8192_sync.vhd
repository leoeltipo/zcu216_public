...
architecture rtl of ssrfft_8x8192_sync is
...
-- FFT scale.
signal o_scale			: std_logic_vector (12 downto 0);
...
-- Registers.
signal scale_reg_i		: std_logic_vector (12 downto 0);
signal qout_reg_i		: unsigned (3 downto 0);

begin

-- Registers.
scale_reg_i <= SCALE_REG (12 downto 0);
