-- Generated from Simulink block ssr_8x8192/Vector FFT/Scalar2Vector
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity ssr_8x8192_scalar2vector is
  port (
...
end ssr_8x8192_scalar2vector;
architecture structural of ssr_8x8192_scalar2vector is 
...
begin
  ...
  slice0 : entity xil_defaultlib.ssr_8x8192_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 53,
    x_width => 432,
  ...
  slice1 : entity xil_defaultlib.ssr_8x8192_xlslice 
  generic map (
    new_lsb => 54,
    new_msb => 107,
    x_width => 432,
  ...
  slice2 : entity xil_defaultlib.ssr_8x8192_xlslice 
  generic map (
    new_lsb => 108,
    new_msb => 161,
    x_width => 432,
  ...
  slice3 : entity xil_defaultlib.ssr_8x8192_xlslice 
  generic map (
    new_lsb => 162,
    new_msb => 215,
    x_width => 432,
  ...
  slice4 : entity xil_defaultlib.ssr_8x8192_xlslice 
  generic map (
    new_lsb => 216,
    new_msb => 269,
    x_width => 432,
  ...
  slice5 : entity xil_defaultlib.ssr_8x8192_xlslice 
  generic map (
    new_lsb => 270,
    new_msb => 323,
    x_width => 432,
  ...
  slice6 : entity xil_defaultlib.ssr_8x8192_xlslice 
  generic map (
    new_lsb => 324,
    new_msb => 377,
    x_width => 432,
  ...
  slice7 : entity xil_defaultlib.ssr_8x8192_xlslice 
  generic map (
    new_lsb => 378,
    new_msb => 431,
    x_width => 432,
...
-- Generated from Simulink block ssr_8x8192/Vector FFT/Vector Concat
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity ssr_8x8192_vector_concat is
  port (
...
end ssr_8x8192_vector_concat;
architecture structural of ssr_8x8192_vector_concat is 
...
begin
  ...
  concat0 : entity xil_defaultlib.sysgen_concat_d8565eac02 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  concat1 : entity xil_defaultlib.sysgen_concat_d8565eac02 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  concat2 : entity xil_defaultlib.sysgen_concat_d8565eac02 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  concat3 : entity xil_defaultlib.sysgen_concat_d8565eac02 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  concat4 : entity xil_defaultlib.sysgen_concat_d8565eac02 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  concat5 : entity xil_defaultlib.sysgen_concat_d8565eac02 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  concat6 : entity xil_defaultlib.sysgen_concat_d8565eac02 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  concat7 : entity xil_defaultlib.sysgen_concat_d8565eac02 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
-- Generated from Simulink block ssr_8x8192/Vector FFT/Vector Delay
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity ssr_8x8192_vector_delay is
  port (
...
end ssr_8x8192_vector_delay;
architecture structural of ssr_8x8192_vector_delay is 
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  delay0 : entity xil_defaultlib.ssr_8x8192_xldelay 
  generic map (
    latency => 4,
    reg_retiming => 0,
    reset => 0,
  ...
  delay1 : entity xil_defaultlib.ssr_8x8192_xldelay 
  generic map (
    latency => 4,
    reg_retiming => 0,
    reset => 0,
  ...
  delay2 : entity xil_defaultlib.ssr_8x8192_xldelay 
  generic map (
    latency => 4,
    reg_retiming => 0,
    reset => 0,
  ...
  delay3 : entity xil_defaultlib.ssr_8x8192_xldelay 
  generic map (
    latency => 4,
    reg_retiming => 0,
    reset => 0,
  ...
  delay4 : entity xil_defaultlib.ssr_8x8192_xldelay 
  generic map (
    latency => 4,
    reg_retiming => 0,
    reset => 0,
  ...
  delay5 : entity xil_defaultlib.ssr_8x8192_xldelay 
  generic map (
    latency => 4,
    reg_retiming => 0,
    reset => 0,
  ...
  delay6 : entity xil_defaultlib.ssr_8x8192_xldelay 
  generic map (
    latency => 4,
    reg_retiming => 0,
    reset => 0,
  ...
  delay7 : entity xil_defaultlib.ssr_8x8192_xldelay 
  generic map (
    latency => 4,
    reg_retiming => 0,
    reset => 0,
...
-- Generated from Simulink block ssr_8x8192/Vector FFT/Vector Reinterpret
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity ssr_8x8192_vector_reinterpret is
  port (
...
end ssr_8x8192_vector_reinterpret;
architecture structural of ssr_8x8192_vector_reinterpret is 
  signal reinterpret1_output_port_net : std_logic_vector( 16-1 downto 0 );
  signal reinterpret2_output_port_net : std_logic_vector( 16-1 downto 0 );
...
begin
  ...
  i_re_6_net <= in_7;
  i_re_7_net <= in_8;
  reinterpret0 : entity xil_defaultlib.sysgen_reinterpret_12a9211b59 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret1 : entity xil_defaultlib.sysgen_reinterpret_12a9211b59 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret2 : entity xil_defaultlib.sysgen_reinterpret_12a9211b59 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret3 : entity xil_defaultlib.sysgen_reinterpret_12a9211b59 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret4 : entity xil_defaultlib.sysgen_reinterpret_12a9211b59 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret5 : entity xil_defaultlib.sysgen_reinterpret_12a9211b59 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret6 : entity xil_defaultlib.sysgen_reinterpret_12a9211b59 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret7 : entity xil_defaultlib.sysgen_reinterpret_12a9211b59 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
-- Generated from Simulink block ssr_8x8192/Vector FFT/Vector Reinterpret1
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity ssr_8x8192_vector_reinterpret1 is
  port (
    in_1 : in std_logic_vector( 16-1 downto 0 );
    in_2 : in std_logic_vector( 16-1 downto 0 );
    in_3 : in std_logic_vector( 16-1 downto 0 );
...
end ssr_8x8192_vector_reinterpret1;
architecture structural of ssr_8x8192_vector_reinterpret1 is 
  signal reinterpret4_output_port_net : std_logic_vector( 16-1 downto 0 );
  signal reinterpret1_output_port_net : std_logic_vector( 16-1 downto 0 );
  signal reinterpret3_output_port_net : std_logic_vector( 16-1 downto 0 );
  signal reinterpret2_output_port_net : std_logic_vector( 16-1 downto 0 );
...
-- Generated from Simulink block ssr_8x8192/Vector FFT/Vector Reinterpret2
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity ssr_8x8192_vector_reinterpret2 is
  port (
...
end ssr_8x8192_vector_reinterpret2;
architecture structural of ssr_8x8192_vector_reinterpret2 is 
...
begin
  ...
  slice6_y_net <= in_7;
  slice7_y_net <= in_8;
  reinterpret0 : entity xil_defaultlib.sysgen_reinterpret_76e7fd6c11 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret1 : entity xil_defaultlib.sysgen_reinterpret_76e7fd6c11 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret2 : entity xil_defaultlib.sysgen_reinterpret_76e7fd6c11 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret3 : entity xil_defaultlib.sysgen_reinterpret_76e7fd6c11 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret4 : entity xil_defaultlib.sysgen_reinterpret_76e7fd6c11 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret5 : entity xil_defaultlib.sysgen_reinterpret_76e7fd6c11 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret6 : entity xil_defaultlib.sysgen_reinterpret_76e7fd6c11 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret7 : entity xil_defaultlib.sysgen_reinterpret_76e7fd6c11 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
-- Generated from Simulink block ssr_8x8192/Vector FFT/Vector Reinterpret3
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity ssr_8x8192_vector_reinterpret3 is
  port (
    in_1 : in std_logic_vector( 27-1 downto 0 );
    in_2 : in std_logic_vector( 27-1 downto 0 );
    in_3 : in std_logic_vector( 27-1 downto 0 );
...
end ssr_8x8192_vector_reinterpret3;
architecture structural of ssr_8x8192_vector_reinterpret3 is 
  signal reinterpret1_output_port_net : std_logic_vector( 27-1 downto 0 );
  signal reinterpret2_output_port_net : std_logic_vector( 27-1 downto 0 );
  signal reinterpret3_output_port_net : std_logic_vector( 27-1 downto 0 );
  signal slice3_y_net : std_logic_vector( 27-1 downto 0 );
...
-- Generated from Simulink block ssr_8x8192/Vector FFT/Vector Slice Im
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity ssr_8x8192_vector_slice_im is
  port (
...
end ssr_8x8192_vector_slice_im;
architecture structural of ssr_8x8192_vector_slice_im is 
...
-- Generated from Simulink block ssr_8x8192/Vector FFT/Vector Slice Re
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity ssr_8x8192_vector_slice_re is
  port (
    in_1 : in std_logic_vector( 54-1 downto 0 );
    in_2 : in std_logic_vector( 54-1 downto 0 );
    in_3 : in std_logic_vector( 54-1 downto 0 );
...
end ssr_8x8192_vector_slice_re;
architecture structural of ssr_8x8192_vector_slice_re is 
  signal slice0_y_net_x0 : std_logic_vector( 27-1 downto 0 );
  signal slice4_y_net_x0 : std_logic_vector( 27-1 downto 0 );
  signal slice5_y_net_x0 : std_logic_vector( 27-1 downto 0 );
  signal slice3_y_net_x0 : std_logic_vector( 27-1 downto 0 );
...
-- Generated from Simulink block ssr_8x8192/Vector FFT/Vector2Scalar
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity ssr_8x8192_vector2scalar is
  port (
...
end ssr_8x8192_vector2scalar;
architecture structural of ssr_8x8192_vector2scalar is 
  signal delay6_q_net : std_logic_vector( 32-1 downto 0 );
  signal delay7_q_net : std_logic_vector( 32-1 downto 0 );
  signal delay4_q_net : std_logic_vector( 32-1 downto 0 );
  signal delay1_q_net : std_logic_vector( 32-1 downto 0 );
...
begin
  ...
  delay6_q_net <= i_7;
  delay7_q_net <= i_8;
  concat1 : entity xil_defaultlib.sysgen_concat_9e2940896b 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
-- Generated from Simulink block ssr_8x8192/Vector FFT
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity ssr_8x8192_vector_fft is
  port (
    i_re_1 : in std_logic_vector( 16-1 downto 0 );
    i_im_1 : in std_logic_vector( 16-1 downto 0 );
    vi : in std_logic_vector( 1-1 downto 0 );
    si : in std_logic_vector( 13-1 downto 0 );
    ...
    vo : out std_logic;
    so : out std_logic_vector( 13-1 downto 0 );
...
end ssr_8x8192_vector_fft;
architecture structural of ssr_8x8192_vector_fft is 
  signal i_scale_net : std_logic_vector( 13-1 downto 0 );
  ...
  signal reinterpret7_output_port_net : std_logic_vector( 27-1 downto 0 );
  signal i_re_2_net : std_logic_vector( 16-1 downto 0 );
  signal test_systolicfft_vhdl_black_box_so_net : std_logic_vector( 13-1 downto 0 );
  signal reinterpret0_output_port_net : std_logic_vector( 27-1 downto 0 );
  ...
  signal delay5_q_net : std_logic_vector( 32-1 downto 0 );
  signal slice6_y_net_x0 : std_logic_vector( 27-1 downto 0 );
  signal delay1_q_net_x0 : std_logic_vector( 13-1 downto 0 );
  signal delay6_q_net : std_logic_vector( 32-1 downto 0 );
  signal slice7_y_net : std_logic_vector( 27-1 downto 0 );
  signal slice3_y_net : std_logic_vector( 27-1 downto 0 );
  signal slice5_y_net_x0 : std_logic_vector( 27-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  scalar2vector : entity xil_defaultlib.ssr_8x8192_scalar2vector 
  port map (
  ...
  vector_concat : entity xil_defaultlib.ssr_8x8192_vector_concat 
  port map (
  ...
  vector_delay : entity xil_defaultlib.ssr_8x8192_vector_delay 
  port map (
    d_1 => concat0_y_net,
  ...
  vector_reinterpret : entity xil_defaultlib.ssr_8x8192_vector_reinterpret 
  port map (
    in_1 => i_re_0_net,
    in_2 => i_re_1_net,
    in_3 => i_re_2_net,
  ...
  vector_reinterpret1 : entity xil_defaultlib.ssr_8x8192_vector_reinterpret1 
  port map (
    in_1 => i_im_0_net,
    in_2 => i_im_1_net,
    in_3 => i_im_2_net,
  ...
  vector_reinterpret2 : entity xil_defaultlib.ssr_8x8192_vector_reinterpret2 
  port map (
    in_1 => slice0_y_net,
    in_2 => slice1_y_net,
    in_3 => slice2_y_net,
  ...
  vector_reinterpret3 : entity xil_defaultlib.ssr_8x8192_vector_reinterpret3 
  port map (
  ...
  vector_slice_im : entity xil_defaultlib.ssr_8x8192_vector_slice_im 
  port map (
  ...
  vector_slice_re : entity xil_defaultlib.ssr_8x8192_vector_slice_re 
  port map (
    in_1 => slice0_y_net_x1,
    in_2 => slice1_y_net_x1,
    in_3 => slice2_y_net_x1,
  ...
  vector2scalar : entity xil_defaultlib.ssr_8x8192_vector2scalar 
  port map (
    i_1 => delay0_q_net,
    i_2 => delay1_q_net,
    i_3 => delay2_q_net,
  ...
  delay : entity xil_defaultlib.ssr_8x8192_xldelay 
  generic map (
    latency => 4,
    reg_retiming => 0,
    reset => 0,
  ...
  test_systolicfft_vhdl_black_box : entity xil_defaultlib.WRAPPER_VECTOR_FFT_b6abbd5e560aea778efb8aba0e27c06f 
  generic map (
    BRAM_THRESHOLD => 258,
    DSP48E => 2,
    I_high => -2,
...
-- Generated from Simulink block ssr_8x8192/i_im
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity ssr_8x8192_i_im is
  port (
...
architecture structural of ssr_8x8192_i_im is 
  signal i_im_2_net : std_logic_vector( 16-1 downto 0 );
  signal i_im_3_net : std_logic_vector( 16-1 downto 0 );
  signal i_im_5_net : std_logic_vector( 16-1 downto 0 );
  signal i_im_4_net : std_logic_vector( 16-1 downto 0 );
...
-- Generated from Simulink block ssr_8x8192/i_re
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity ssr_8x8192_i_re is
  port (
...
architecture structural of ssr_8x8192_i_re is 
  signal i_re_0_net : std_logic_vector( 16-1 downto 0 );
  signal i_re_7_net : std_logic_vector( 16-1 downto 0 );
  signal i_re_2_net : std_logic_vector( 16-1 downto 0 );
  signal i_re_5_net : std_logic_vector( 16-1 downto 0 );
...
-- Generated from Simulink block ssr_8x8192_struct
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity ssr_8x8192_struct is
  port (
    i_scale : in std_logic_vector( 13-1 downto 0 );
    ...
    clk_1 : in std_logic;
    ce_1 : in std_logic;
    o_scale : out std_logic_vector( 13-1 downto 0 );
...
end ssr_8x8192_struct;
architecture structural of ssr_8x8192_struct is 
  signal reinterpret2_output_port_net : std_logic_vector( 27-1 downto 0 );
  signal clk_net : std_logic;
  signal reinterpret0_output_port_net_x0 : std_logic_vector( 27-1 downto 0 );
  signal reinterpret7_output_port_net : std_logic_vector( 27-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  vector_fft : entity xil_defaultlib.ssr_8x8192_vector_fft 
  port map (
    i_re_1 => i_re_0_net,
    i_im_1 => i_im_0_net,
    vi => i_valid_net,
  ...
  i_im : entity xil_defaultlib.ssr_8x8192_i_im 
  port map (
    i_im_0 => i_im_0_net,
    i_im_1 => i_im_1_net,
    i_im_2 => i_im_2_net,
  ...
  i_re : entity xil_defaultlib.ssr_8x8192_i_re 
  port map (
    i_re_0 => i_re_0_net,
    i_re_1 => i_re_1_net,
    i_re_2 => i_re_2_net,
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity ssr_8x8192_default_clock_driver is
  port (
    ssr_8x8192_sysclk : in std_logic;
    ssr_8x8192_sysce : in std_logic;
    ssr_8x8192_sysclr : in std_logic;
    ssr_8x8192_clk1 : out std_logic;
    ssr_8x8192_ce1 : out std_logic
  );
end ssr_8x8192_default_clock_driver;
architecture structural of ssr_8x8192_default_clock_driver is 
begin
  ...
  port map (
    sysclk => ssr_8x8192_sysclk,
    sysce => ssr_8x8192_sysce,
    sysclr => ssr_8x8192_sysclr,
    clk => ssr_8x8192_clk1,
    ce => ssr_8x8192_ce1
  );
end structural;
...
architecture structural of ssr_8x8192 is 
  attribute core_generation_info : string;
  attribute core_generation_info of structural : architecture is "ssr_8x8192,sysgen_core_2019_2,{,compilation=HDL Netlist,block_icon_display=Default,family=zynquplusRFSOC,part=xczu28dr,speed=-2-e,package=ffvg1517,synthesis_language=vhdl,hdl_library=xil_defaultlib,synthesis_strategy=Vivado Synthesis Defaults,implementation_strategy=Vivado Implementation Defaults,testbench=0,interface_doc=0,ce_clr=0,clock_period=10,system_simulink_period=1,waveform_viewer=0,axilite_interface=0,ip_catalog_plugin=0,hwcosim_burst_mode=0,simulation_time=10,blackbox2=1,concat=9,delay=10,reinterpret=32,slice=24,}";
  signal clk_1_net : std_logic;
  signal ce_1_net : std_logic;
begin
  ssr_8x8192_default_clock_driver : entity xil_defaultlib.ssr_8x8192_default_clock_driver 
  port map (
    ssr_8x8192_sysclk => clk,
    ssr_8x8192_sysce => '1',
    ssr_8x8192_sysclr => '0',
    ssr_8x8192_clk1 => clk_1_net,
    ssr_8x8192_ce1 => ce_1_net
  );
  ssr_8x8192_struct : entity xil_defaultlib.ssr_8x8192_struct 
  port map (
    i_scale => i_scale,
    i_valid => i_valid,
    i_im_0 => i_im_0,
