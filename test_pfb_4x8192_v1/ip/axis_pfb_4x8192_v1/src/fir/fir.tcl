...
set_property -dict [list \
	...
	CONFIG.Coefficient_File {/home/lstefana/v20.2/ip/axis_pfb_4x8192_v1/src/fir/coef/fir_0.coe} \
	CONFIG.Coefficient_Sets {1024} \
	CONFIG.Filter_Type {Interpolated} \
	CONFIG.Number_Channels {1024} \
...
set_property -dict [list \
	CONFIG.CoefficientSource {COE_File} \
	CONFIG.Coefficient_File {/home/lstefana/v20.2/ip/axis_pfb_4x8192_v1/src/fir/coef/fir_1.coe} \
	CONFIG.Coefficient_Sets {1024} \
	CONFIG.Filter_Type {Interpolated} \
	CONFIG.Number_Channels {1024} \
	CONFIG.Number_Paths {2} \
...
set_property -dict [list \
	CONFIG.CoefficientSource {COE_File} \
	CONFIG.Coefficient_File {/home/lstefana/v20.2/ip/axis_pfb_4x8192_v1/src/fir/coef/fir_2.coe} \
	CONFIG.Coefficient_Sets {1024} \
	CONFIG.Filter_Type {Interpolated} \
	CONFIG.Number_Channels {1024} \
	CONFIG.Number_Paths {2} \
...
set_property -dict [list \
	CONFIG.CoefficientSource {COE_File} \
	CONFIG.Coefficient_File {/home/lstefana/v20.2/ip/axis_pfb_4x8192_v1/src/fir/coef/fir_3.coe} \
	CONFIG.Coefficient_Sets {1024} \
	CONFIG.Filter_Type {Interpolated} \
	CONFIG.Number_Channels {1024} \
	CONFIG.Number_Paths {2} \
...
set_property -dict [list \
	CONFIG.CoefficientSource {COE_File} \
	CONFIG.Coefficient_File {/home/lstefana/v20.2/ip/axis_pfb_4x8192_v1/src/fir/coef/fir_4.coe} \
	CONFIG.Coefficient_Sets {1024} \
	CONFIG.Filter_Type {Interpolated} \
	CONFIG.Number_Channels {1024} \
	CONFIG.Number_Paths {2} \
...
set_property -dict [list \
	CONFIG.CoefficientSource {COE_File} \
	CONFIG.Coefficient_File {/home/lstefana/v20.2/ip/axis_pfb_4x8192_v1/src/fir/coef/fir_5.coe} \
	CONFIG.Coefficient_Sets {1024} \
	CONFIG.Filter_Type {Interpolated} \
	CONFIG.Number_Channels {1024} \
	CONFIG.Number_Paths {2} \
...
set_property -dict [list \
	CONFIG.CoefficientSource {COE_File} \
	CONFIG.Coefficient_File {/home/lstefana/v20.2/ip/axis_pfb_4x8192_v1/src/fir/coef/fir_6.coe} \
	CONFIG.Coefficient_Sets {1024} \
	CONFIG.Filter_Type {Interpolated} \
	CONFIG.Number_Channels {1024} \
	CONFIG.Number_Paths {2} \
...
set_property -dict [list \
	CONFIG.CoefficientSource {COE_File} \
	CONFIG.Coefficient_File {/home/lstefana/v20.2/ip/axis_pfb_4x8192_v1/src/fir/coef/fir_7.coe} \
	CONFIG.Coefficient_Sets {1024} \
	CONFIG.Filter_Type {Interpolated} \
	CONFIG.Number_Channels {1024} \
	CONFIG.Number_Paths {2} \
